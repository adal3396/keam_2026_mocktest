  ...
  return (
    <div className="h-screen bg-muted flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
            ...
            <div className="max-w-4xl mx-auto space-y-5 pb-8">
              ...
              <Card className={cn(
                ...
                <CardContent className="p-6 md:p-8 space-y-6">
                  <MathRenderer text={currentQ.questionText} className="text-lg leading-relaxed font-medium" />
                  {currentQ.imageUrl && (
                ...
                {validOptions.map(opt => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <MathRenderer text={optionText} className={cn("text-base", isSelected ? "font-semibold text-foreground" : "text-muted-foreground")} />
                    </button>
                  );
                })}
              </div>
        ...
        <div className="hidden lg:flex flex-col w-80 border-l bg-card shadow-[-4px_0_15px_-3px_rgba(0,0,0,0.05)] overflow-hidden">
          {/* Status summary */}
